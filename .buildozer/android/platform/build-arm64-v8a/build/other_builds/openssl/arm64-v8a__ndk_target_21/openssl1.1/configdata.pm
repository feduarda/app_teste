...
our %config = (
  ...
  CPPFLAGS => [ "-DANDROID -I/home/user/.buildozer/android/platform/android-ndk-r25b/toolchains/llvm/prebuilt/linux-x86_64/sysroot/usr/include -I/home/user/hostcwd/.buildozer/android/platform/build-arm64-v8a/build/python-installs/ICDrone/arm64-v8a/include/python3.1" ],
  CPPINCLUDES => [  ],
  CXX => "/usr/bin/ccache /home/user/.buildozer/android/platform/android-ndk-r25b/toolchains/llvm/prebuilt/linux-x86_64/bin/clang++ -target aarch64-linux-android21 -fomit-frame-pointer -march=armv8-a -fPIC",
